...
function handleMessage(sender_psid, message) {
    ...
    if( message && message.attachments && message.attachments[0].payload){
        callSendAPI(sender_psid, "Thank you for exploring our business page!!!");
    ...
    if(entityChosen === ""){
       ...
       if(entityChosen === "wit$greetings"){
           ...
           callSendAPI(sender_psid,'Hi there! This bot is created by Priyadharshini! How can i help you?');
       }
